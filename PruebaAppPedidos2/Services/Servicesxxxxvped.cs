        ...
        public static async Task crearEncabezadoTemp(string codigoCliente, ModelDespacho despacho)
        {
            ...
            try
            {
                string query = $"INSERT INTO `a000`.`xxxxvpex` " +
                    ...
                    $"VALUES " +
                    $"('{codigoCliente}', 'Temp', '{date}', '1', '0000', 'cpp66f', '{date}', '{time}', 'Prueba de agregar5', 'C00', '100000', '0', '125000', '000', '0', '0', '0', '0', '{despacho.titular}', '{despacho.titudire}', '{despacho.titutelf}', '{despacho.tituciud}', '0', '1', '0', '000', 'a002', '0', '0')";
                MySqlCommand comando = new MySqlCommand(query);
                MySqlDataReader reader = null;
                comando.Connection = conexionBD;
                conexionBD.Open();
